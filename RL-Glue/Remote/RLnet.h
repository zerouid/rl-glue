...
int rlOpen(short port);
int rlAcceptConnection(int socket);
int rlIsValidSocket(int socket);
int rlConnect(int socket, const char* address, short port);
int rlListen(int socket, short port);
int rlClose(int socket);
