...
% 
% This content has been removed because we are no longer have thse functions.
%
...
\begin{description}
	...
	\item [librlgluenetdev] A C library that can includes the network code that is used by the rl\_glue socket server.  This code is re-used by the C/C++ network codec and by other custom codecs such as the Atari project.
